...
ax = sns.barplot(data = netmhc2_df_labels_carriers_counts, x = 'gene_var2', y = 'count', order = order_by_total2, color = col_pos, width = 0.6)
...
plt.figure(figsize = (16,4))
ax = sns.barplot(data = netmhc_df_labels_carriers_counts, x = 'gene_var2', y = 'count', hue = 'MHC', order = order_by_total2, palette = colors, width = 0.6)
plt.xlim(-0.5, len(order_by_total)-0.5)
plt.ylim(0, 1700)
plt.xlabel(f'CH variant', fontsize = xaxis_font)
plt.ylabel('Number of CH-positive individuals', fontsize = yaxis_font)
