...
ax = sns.barplot(data = net12_df_carriers_counts, x = 'gene_var2', y = 'count', hue = 'MHC', order = order_by_total2, palette = colors, width = 0.6)
...
for lab in order_by_total2:
    if '\n' in lab:
        ...
        gene = gene.replace('_', r'\_')  # escape underscores if needed
        new_labels.append(rf'$\it{{{gene}}}$' + '\n' + variant)
    else:
...
plt.xticks(tick_positions, new_labels, rotation=90, fontsize = xticks_font)
plt.yticks(fontsize = yticks_font)
...
for k in mhcrs:
    ...
    if hla[0] == 'D':
        ...
        ukb_total = len(netmhc2_df.Person_ID.unique())
        carriers_total = len(netmhc2_df[netmhc2_df['gene_var']==gene_var].Person_ID)
        ...
        ukb_total = len(netmhc1_df.Person_ID.unique())
        carriers_total = len(netmhc1_df[netmhc1_df['gene_var']==gene_var].Person_ID)
...
# save the main figure  
plt.savefig(f'/Users/barbarawalkowiak/Desktop/msc_thesis/results/supplementary_files/{df}/sf6/6a_carriers_present_vs_absent_variants_{df}.pdf', bbox_inches='tight')
...
# save the main figure 
plt.savefig(f'/Users/barbarawalkowiak/Desktop/msc_thesis/results/supplementary_files/{df}/sf6/6b_carriers_present_vs_absent_variants_aggregated_{df}.pdf', bbox_inches='tight')
...
# save the main figure 
plt.savefig(f'/Users/barbarawalkowiak/Desktop/msc_thesis/results/supplementary_files/{df}/sf6/6b_carriers_present_vs_absent_variants_aggregated_rm_mostcommon{df}.pdf', bbox_inches='tight')
